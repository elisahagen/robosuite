...
def quaternion_to_matrix(quaternions: torch.Tensor) -> torch.Tensor:
    ...
    Args:
        quaternions: quaternions with real part first (wxyz),
...
def quaternion_to_rotation_6d(quaternions):
    rot_mat = quaternion_to_matrix(quaternions) # wxyz -> 6d
    rot_6d = matrix_to_rotation_6d(rot_mat) # 6d to wxyz
    return rot_6d

def rotation_6d_to_quaternion(d6):
    rot_mat = rotation_6d_to_matrix(d6)
    quat = matrix_to_quaternion(rot_mat) # wxyz
    return quat